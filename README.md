...
- Escolher se o domínio abre a página de login ou um evento público específico.
- Escolher tema global claro, escuro ou Amazônia para painel, eventos e tickets.
